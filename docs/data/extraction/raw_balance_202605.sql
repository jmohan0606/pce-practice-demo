...
-- Save the result as CSV (header row, comma, UTF-8): data/real/_raw/raw_balance_202605.csv
-- Month-end balances for 202605: columns confirmed acct_id / acct_bal.
...
SELECT '202605' AS month_id, b.acct_id, b.acct_bal
