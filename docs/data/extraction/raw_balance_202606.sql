...
-- Save the result as CSV (header row, comma, UTF-8): data/real/_raw/raw_balance_202606.csv
-- Month-end balances for 202606: columns confirmed acct_id / acct_bal.
...
SELECT '202606' AS month_id, b.acct_id, b.acct_bal
